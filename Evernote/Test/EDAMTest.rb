...
authToken = "S=s1:U=243ad:E=13f0ce0c833:C=137b52f9c33:P=1cd:A=en-devtoken:H=2fffbf527bfc49d8137ff0079df919d2"

if (authToken == "your developer token")
  puts "Please fill in your developer token"
  puts "To get a developer token, visit https://sandbox.evernote.com/dev/DeveloperToken.action"
  exit(1)
end
